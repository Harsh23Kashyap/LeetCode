...
<p>Return a string of the unique letters in the new alien language sorted in <strong>lexicographically increasing order</strong> by the new language's rules. If there is no valid ordering, return <code>""</code>. If there are multiple valid orderings, return <strong>any of them</strong>.</p>
